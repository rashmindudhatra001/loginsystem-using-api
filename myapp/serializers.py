...
class RegisterSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['username', 'email', 'first_name', 'last_name',
                  'phone_number', 'address', 'city', 'gender', 'age',
                  'password', 'confirm_password']
    ...
    def validate(self, attrs):
        ...
        if SoftDeletedUser.objects.filter(username=username).exists() or SoftDeletedUser.objects.filter(email=email).exists():
            raise serializers.ValidationError("This account was deleted. Recover instead.")
...
class ProfileUpdateSerializer(serializers.ModelSerializer):
    class Meta:
        model = User
        fields = ['first_name', 'last_name', 'phone_number', 'address', 'city', 'gender', 'age']
